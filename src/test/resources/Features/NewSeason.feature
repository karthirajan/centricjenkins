Feature: Create New season in qakripya.com
  ...
  Scenario Outline: User creates New season for a product
    ...
    Examples: 
      ...
      | Italian (Italiano) | autumn6 |   100 | new model    | brand |   101 | otto         | dept | ot01  | shirts       | collection | Cot001 | cotton      | Apparel   |
      | English - UK       | spring6 |   101 | new model    | brand |   101 | otto         | dept | ot01  | T-shirts     | collection | Cot001 | cotton      | Apparel   |
      | English - USA      | winter6 |   102 | new model    | brand |   101 | otto         | dept | ot01  | pants        | collection | Cot001 | cotton      | Apparel   |
